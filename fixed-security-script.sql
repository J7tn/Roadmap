-- Fixed Security Script for Supabase Database
-- This script properly handles function dependencies

-- ==============================================
-- PART 1: Drop All Triggers First
-- ==============================================
...
-- ==============================================
-- PART 2: Drop and Recreate Function with Security
-- ==============================================
...
-- ==============================================
-- PART 5: Recreate All Triggers with Secure Function
-- ==============================================
...
CREATE TRIGGER update_career_update_log_updated_at 
...
CREATE TRIGGER update_trending_update_log_updated_at 
